...
Frame.Position = UDim2.new(0.671350658, 0, 0.951552808, 0)
Frame.Size = UDim2.new(0, 203, 0, 39)

TextLabel.Parent = ScreenGui
TextLabel.BackgroundColor3 = Color3.new(0, 0, 0)
TextLabel.BorderColor3 = Color3.new(0, 0, 0)
TextLabel.BorderSizePixel = 0
TextLabel.Position = UDim2.new(0, 0, 0.972670794, 0)
TextLabel.Size = UDim2.new(0, 167, 0, 22)
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = "🌙  Lunar Ware V1"
TextLabel.TextColor3 = Color3.new(0.94902, 1, 0)
